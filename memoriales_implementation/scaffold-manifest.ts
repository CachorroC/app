...
// Usage: npx tsx scaffold-manifest.ts <path-to-template.docx> <template-id> > draft.ts
// Emits a draft MemorialTemplate you then enrich (labels / types / formats / required).
