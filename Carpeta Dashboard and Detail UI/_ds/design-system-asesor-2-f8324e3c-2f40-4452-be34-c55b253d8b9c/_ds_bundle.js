...
const __ds_ns = (window.DesignSystemAsesor2_f8324e = window.DesignSystemAsesor2_f8324e || {});
...
function Avatar({
  ...
  const cls = ['aj-avatar', size !== 'md' ? `aj-avatar--${size}` : '', className].filter(Boolean).join(' ');
...
function Badge({
  ...
  if (dot) return /*#__PURE__*/React.createElement("span", _extends({
    className: ['aj-badge', 'aj-badge--dot', variant !== 'error' ? `aj-badge--${variant}` : '', className].filter(Boolean).join(' ')
  }, rest));
  const display = typeof count === 'number' && count > max ? `${max}+` : count;
  return /*#__PURE__*/React.createElement("span", _extends({
    className: ['aj-badge', variant !== 'error' ? `aj-badge--${variant}` : '', className].filter(Boolean).join(' ')
  }, rest), display);
}
...
function Card({
  ...
  const cls = ['aj-card', variant !== 'outlined' ? `aj-card--${variant}` : '', padded ? 'aj-card--pad' : '', interactive ? 'aj-card--interactive' : '', className].filter(Boolean).join(' ');
...
function Chip({
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    className: ['aj-chip', selected ? 'aj-chip--selected' : '', className].filter(Boolean).join(' '),
    ...
    className: "material-symbols-rounded",
    "aria-hidden": "true"
  }, icon), label ?? children, trailingIcon && /*#__PURE__*/React.createElement("span", {
    className: "material-symbols-rounded",
    "aria-hidden": "true"
  }, trailingIcon));
}
...
function StatusChip({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: ['aj-status', `aj-status--${status}`, className].filter(Boolean).join(' ')
  }, rest), dot && /*#__PURE__*/React.createElement("span", {
    className: "aj-status__dot",
    "aria-hidden": "true"
  }), !dot && showIcon && meta.icon && /*#__PURE__*/React.createElement("span", {
    className: "material-symbols-rounded",
    "aria-hidden": "true"
  }, meta.icon), text);
}
...
function Button({
  ...
  const cls = ['aj-btn', `aj-btn--${variant}`, size !== 'md' ? `aj-btn--${size}` : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("button", _extends({
    type: type,
    className: cls
...
function Checkbox({
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: ['aj-check', className].filter(Boolean).join(' ')
...
function IconButton({
  ...
  const cls = ['aj-iconbtn', variant !== 'standard' ? `aj-iconbtn--${variant}` : '', size === 'sm' ? 'aj-iconbtn--sm' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("button", _extends({
    type: "button",
    className: cls,
    "aria-label": ariaLabel
...
function Select({
  ...
  const wrap = ['aj-field', block ? 'aj-field--block' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("label", {
    className: wrap,
    htmlFor: id
...
function Switch({
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: ['aj-switch', className].filter(Boolean).join(' '),
    style: label ? {
      gap: 'var(--space-3)'
    } : undefined
  }, /*#__PURE__*/React.createElement("input", _extends({
...
function TextField({
  ...
  const cls = ['aj-field', block ? 'aj-field--block' : '', mono ? 'aj-field--mono' : '', error ? 'aj-field--error' : '', disabled ? 'aj-field--disabled' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("label", {
    className: cls,
    htmlFor: id
  }, label && /*#__PURE__*/React.createElement("span", {
...
function Tabs({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: ['aj-tabs', className].filter(Boolean).join(' '),
    role: "tablist"
  }, rest), tabs.map(t => {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: ['aj-tab', active ? 'aj-tab--active' : ''].filter(Boolean).join(' '),
      onClick: () => onChange && onChange(tab.value)
    }, tab.icon && /*#__PURE__*/React.createElement("span", {
      className: "material-symbols-rounded",
      "aria-hidden": "true"
    }, tab.icon), tab.label, typeof tab.count === 'number' && /*#__PURE__*/React.createElement("span", {
...
function App() {
  ...
  const [nav, setNav] = React.useState('carpetas');
  ...
  const counts = React.useMemo(() => {
    ...
    D.categories.forEach(cat => {
      if (cat.key === 'todos') return;
      c[cat.key] = D.carpetas.filter(x => x.category === cat.key).length;
    });
    return c;
  }, []);
  function handleNav(key, cat) {
    if (key === 'logout') {
      setAuthed(false);
      return;
    }
  ...
  const titles = {
    carpetas: {
      t: 'Carpetas',
      s: `${D.carpetas.length} procesos · ${D.carpetas.filter(c => c.vencido).length} requieren atención`
    },
    agenda: {
      t: 'Agenda',
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    active: selected ? 'carpetas' : nav,
    onNav: handleNav,
    categories: D.categories.filter(c => c.key !== 'todos'),
    counts: counts
  }), /*#__PURE__*/React.createElement("div", {
    className: "aj-main"
  }, /*#__PURE__*/React.createElement(TopBar, {
    title: selected ? 'Detalle de carpeta' : head.t,
    subtitle: selected ? `N.º ${selected.numero}` : head.s,
    search: search,
    onSearch: setSearch
  }), /*#__PURE__*/React.createElement("div", {
    className: "aj-content"
  }, selected ? /*#__PURE__*/React.createElement(CarpetaDetail, {
    carpeta: selected,
    data: D,
    onBack: () => setSelected(null)
  }) : nav === 'carpetas' ? /*#__PURE__*/React.createElement(CarpetasView, {
    carpetas: D.carpetas,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/asesor/App.jsx", error: String((e && e.message) || e) }); }
...
function CarpetaDetail({
  ...
  const tabs = [{
    ...
    label: 'Tareas',
    icon: 'check_circle',
    count: data.tareas.filter(t => !t.done).length
  }];
  const kv = (k, v, mono) => /*#__PURE__*/React.createElement("div", {
    className: "aj-kv__item"
  }, /*#__PURE__*/React.createElement("span", {
    className: "aj-kv__k"
  }, k), /*#__PURE__*/React.createElement("span", {
    className: 'aj-kv__v' + (mono ? ' mono' : '')
  }, v));
  return /*#__PURE__*/React.createElement("div", {
    className: "aj-detail"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Carpeta N.\xBA ", carpeta.numero, " \xB7 ", carpeta.radicado), /*#__PURE__*/React.createElement("h1", {
    className: "aj-detail__title"
  }, carpeta.nombre), /*#__PURE__*/React.createElement("div", {
  ...
  }, tipoLabel[carpeta.tipoProceso]))), /*#__PURE__*/React.createElement(Button, {
    variant: "tonal",
    icon: "edit"
  }, "Editar")), /*#__PURE__*/React.createElement(Tabs, {
    value: tab,
    onChange: setTab,
    tabs: tabs
    ...
    className: "material-symbols-rounded"
  }, "account_balance"), "Informaci\xF3n del proceso"), /*#__PURE__*/React.createElement("div", {
    className: "aj-kv"
  }, kv('Juzgado', carpeta.juzgado), kv('Ciudad', carpeta.ciudad), kv('Etapa procesal', carpeta.etapa), kv('Tipo de proceso', tipoLabel[carpeta.tipoProceso]), kv('Capital adeudado', fmtCOP(carpeta.capital), true), kv('Avalúo', carpeta.avaluo ? fmtCOP(carpeta.avaluo) : '—', true), kv('Última actuación', carpeta.ultimaActuacion), kv('Fecha', fmtDate(carpeta.fechaUltimaAct), true))), /*#__PURE__*/React.createElement(Card, {
    variant: "filled",
    padded: true
  }, /*#__PURE__*/React.createElement("div", {
    className: "aj-panel-title"
    ...
    className: "material-symbols-rounded"
  }, "person"), "Deudor"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 'var(--space-3)',
  ...
  }, carpeta.deudor.nombre), /*#__PURE__*/React.createElement("div", {
    style: {
      font: 'var(--type-body-sm)',
      color: 'var(--md-on-surface-variant)'
    }
  }, "C.C. ", carpeta.deudor.cedula))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 'var(--space-3)'
    }
  }, kv('Teléfono', carpeta.deudor.tel, true), kv('Correo', carpeta.deudor.email), kv('Ciudad', carpeta.deudor.ciudad)))), tab === 'deudor' && /*#__PURE__*/React.createElement(Card, {
    variant: "outlined",
    padded: true
  }, /*#__PURE__*/React.createElement("div", {
    className: "aj-panel-title"
    ...
    className: "material-symbols-rounded"
  }, "person"), "Datos del deudor"), /*#__PURE__*/React.createElement("div", {
    className: "aj-kv"
  }, kv('Nombre completo', carpeta.deudor.nombre), kv('Cédula', carpeta.deudor.cedula, true), kv('Teléfono', carpeta.deudor.tel, true), kv('Correo electrónico', carpeta.deudor.email), kv('Ciudad', carpeta.deudor.ciudad))), tab === 'demanda' && /*#__PURE__*/React.createElement(Card, {
    variant: "outlined",
    padded: true
  }, /*#__PURE__*/React.createElement("div", {
    className: "aj-panel-title"
    ...
    className: "material-symbols-rounded"
  }, "gavel"), "Demanda"), /*#__PURE__*/React.createElement("div", {
    className: "aj-kv"
  }, kv('Radicado', carpeta.radicado, true), kv('Despacho', carpeta.juzgado), kv('Etapa procesal', carpeta.etapa), kv('Tipo de proceso', tipoLabel[carpeta.tipoProceso]), kv('Capital adeudado', fmtCOP(carpeta.capital), true), kv('Avalúo', carpeta.avaluo ? fmtCOP(carpeta.avaluo) : '—', true))), tab === 'actuaciones' && /*#__PURE__*/React.createElement(Card, {
    variant: "outlined",
    padded: true
  }, /*#__PURE__*/React.createElement("div", {
    className: "aj-panel-title"
    ...
    className: "material-symbols-rounded"
  }, "history"), "Actuaciones procesales"), /*#__PURE__*/React.createElement("div", {
    className: "aj-timeline"
  }, data.actuaciones.map((a, i) => /*#__PURE__*/React.createElement("div", {
  ...
  }, fmtDate(a.fecha), a.conDocumentos && ' · con documentos'), /*#__PURE__*/React.createElement("span", {
    className: "aj-tl-act"
  }, a.actuacion), /*#__PURE__*/React.createElement("span", {
    className: "aj-tl-note"
  }, a.anotacion)))))), tab === 'facturas' && /*#__PURE__*/React.createElement(Card, {
    variant: "outlined",
    padded: true
  }, /*#__PURE__*/React.createElement("div", {
    className: "aj-panel-title"
    ...
    className: "material-symbols-rounded"
  }, "receipt_long"), "Facturaci\xF3n"), data.facturas.map(f => /*#__PURE__*/React.createElement("div", {
    className: "aj-frow",
    key: f.id
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, f.razonSocial), /*#__PURE__*/React.createElement(StatusChip, {
    status: f.estado === 'Pagada' ? 'done' : 'review',
    label: f.estado
  }), /*#__PURE__*/React.createElement("span", {
    className: "aj-frow__amt"
  }, fmtCOP(f.valorTotal))))), tab === 'tareas' && /*#__PURE__*/React.createElement(Card, {
    variant: "outlined",
    padded: true
  }, /*#__PURE__*/React.createElement("div", {
    className: "aj-panel-title"
    ...
    className: "material-symbols-rounded"
  }, "check_circle"), "Tareas pendientes"), /*#__PURE__*/React.createElement("div", {
    className: "aj-tasklist"
  }, data.tareas.map((t, i) => {
    const over = !t.done && new Date(t.dueDate) < new Date('2026-06-18');
    return /*#__PURE__*/React.createElement("div", {
      className: "aj-task",
      key: i
      ...
      className: 'aj-task__text' + (t.done ? ' done' : '')
    }, t.text), /*#__PURE__*/React.createElement("span", {
      className: 'aj-task__due' + (over ? ' over' : '')
    }, fmtDate(t.dueDate)));
  }))));
}
window.CarpetaDetail = CarpetaDetail;
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/asesor/CarpetaDetail.jsx", error: String((e && e.message) || e) }); }
...
function CarpetasView({
  ...
  const filtered = carpetas.filter(c => {
    ...
    const matchesQ = !q || c.nombre.toLowerCase().includes(q) || String(c.numero).includes(q) || c.radicado.toLowerCase().includes(q);
    return matchesCat && matchesQ;
  });
  const totalCapital = carpetas.reduce((s, c) => s + (c.terminado ? 0 : c.capital), 0);
  const activos = carpetas.filter(c => !c.terminado).length;
  const vencidos = carpetas.filter(c => c.vencido).length;
  const porRevisar = carpetas.filter(c => !c.revisado && !c.terminado).length;
  const stats = [{
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: 'aj-stat__value' + (s.money ? ' money' : '')
    ...
    className: "aj-table"
  }, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("th", null, "N.\xBA"), /*#__PURE__*/React.createElement("th", null, "Carpeta"), /*#__PURE__*/React.createElement("th", null, "Categor\xEDa"), /*#__PURE__*/React.createElement("th", null, "Etapa procesal"), /*#__PURE__*/React.createElement("th", null, "Capital"), /*#__PURE__*/React.createElement("th", null, "Estado"), /*#__PURE__*/React.createElement("th", null))), /*#__PURE__*/React.createElement("tbody", null, filtered.map(c => {
    ...
    return /*#__PURE__*/React.createElement("tr", {
      ...
      className: "num"
    }, c.numero), /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement("div", {
      className: "aj-cell-case"
    }, /*#__PURE__*/React.createElement("span", {
      className: "name"
    }, c.nombre), /*#__PURE__*/React.createElement("span", {
      className: "meta"
    }, tipoLabel[c.tipoProceso], " \xB7 ", c.juzgado))), /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement("span", {
      className: "aj-cat-dot"
    }, /*#__PURE__*/React.createElement("span", {
      className: "d",
      style: {
    ...
    }), cat.label)), /*#__PURE__*/React.createElement("td", null, c.etapa), /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement("span", {
      className: "aj-money"
    }, c.capital ? fmtCOP(c.capital) : '—')), /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement(StatusChip, {
      status: c.status
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/asesor/CarpetasView.jsx", error: String((e && e.message) || e) }); }
...
function LoginView({
  ...
  const [email, setEmail] = React.useState('carlos.vega@bufete.co');
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    alt: ""
  }), /*#__PURE__*/React.createElement("span", null, "Asesor Jur\xEDdico")), /*#__PURE__*/React.createElement("div", {
    className: "aj-login__pitch"
  }, /*#__PURE__*/React.createElement("h2", null, "Gestione cada proceso en un solo lugar."), /*#__PURE__*/React.createElement("p", null, "Carpetas, demandas, actuaciones y facturaci\xF3n \u2014 sincronizadas con los juzgados.")), /*#__PURE__*/React.createElement("span", {
    className: "aj-login__foot"
  }, "\xA9 2026 Asesor Jur\xEDdico \xB7 Bogot\xE1, Colombia")), /*#__PURE__*/React.createElement("div", {
    className: "aj-login__form"
  }, /*#__PURE__*/React.createElement("div", {
    className: "aj-login__card"
  }, /*#__PURE__*/React.createElement("h3", null, "Iniciar sesi\xF3n"), /*#__PURE__*/React.createElement("span", {
    className: "sub"
  }, "Acceda a su tablero de procesos"), /*#__PURE__*/React.createElement(TextField, {
    block: true,
    label: "Correo",
    leadingIcon: "mail",
    value: email,
  ...
  }, "\xBFOlvid\xF3 su contrase\xF1a?")), /*#__PURE__*/React.createElement(Button, {
    variant: "filled",
    size: "lg",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/asesor/LoginView.jsx", error: String((e && e.message) || e) }); }
...
function Sidebar({
  ...
  return /*#__PURE__*/React.createElement("aside", {
    ...
    className: "b"
  }, "Jur\xEDdico"))), /*#__PURE__*/React.createElement("nav", {
    className: "aj-sidebar__nav"
  }, navMain.map(n => /*#__PURE__*/React.createElement("button", {
    key: n.key,
    className: 'aj-navitem' + (active === n.key ? ' aj-navitem--active' : ''),
    onClick: () => onNav(n.key)
  }, /*#__PURE__*/React.createElement("span", {
    className: "material-symbols-rounded",
    "aria-hidden": "true"
  ...
  }, "Categor\xEDas"), /*#__PURE__*/React.createElement("nav", {
    className: "aj-sidebar__nav"
  }, categories.map(c => /*#__PURE__*/React.createElement("button", {
    key: c.key,
    className: "aj-navitem aj-navitem--sub",
    onClick: () => onNav('carpetas', c.key)
  }, /*#__PURE__*/React.createElement("span", {
    className: "material-symbols-rounded",
    "aria-hidden": "true"
  }, c.icon), c.label, counts[c.key] != null && /*#__PURE__*/React.createElement("span", {
    className: "aj-navitem__count"
  }, counts[c.key])))), /*#__PURE__*/React.createElement("div", {
    ...
    className: "n"
  }, "Carlos Vega"), /*#__PURE__*/React.createElement("span", {
    className: "r"
  }, "Abogado titular")), /*#__PURE__*/React.createElement(IconButton, {
    icon: "logout",
    "aria-label": "Salir",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/asesor/Sidebar.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/asesor/TopBar.jsx", error: String((e && e.message) || e) }); }
...
window.AJ_DATA = function () {
  ...
  const actuaciones = [{
    ...
    anotacion: 'Se admite y se ordena mandamiento de pago contra el deudor.',
    conDocumentos: true
  }, {
    fecha: '2026-05-21',
    actuacion: 'Reparto',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/asesor/data.js", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/asesor/helpers.js", error: String((e && e.message) || e) }); }
