...
export function useSnackbarContext() {
  ...
  if ( context === null ) {
    throw new Error( 'el snackbar context debe ser utilizado dentro de un snackbar context provider ', );
  }
...
export function useContactContext() {
  ...
  if ( context === null ) {
    throw new Error( 'el contexto para contacto se debe utilizar dentro de un proveedor de contacto', );
  }
