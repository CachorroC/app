...
export function ExpedienteFormComponent({
  ...
  const [departamentoState, setDepartamentoState] = useState('00');

  const [municipioState, setMunicipioState] = useState('000');

  const [entidadState, setEntidadState] = useState('00');

  const [especialidadState, setEspecialidadState] = useState('00');

  const [despachoState, setDespachoState] = useState('000');

  const [anoState, setAnoState] = useState(String(new Date().getFullYear()));

  const [codigoState, setCodigoState] = useState('00000');

  const [recursoState, setRecursoState] = useState('00');
