...
export class carpetaConvert {
  ...
  public static toMonCarpeta(carpeta: WithId<IntCarpeta>): MonCarpeta {
    return {
      ...carpeta,
      fecha: carpeta.fecha ? new Date(carpeta.fecha) : null,
      idRegUltimaAct: carpeta.idRegUltimaAct ? carpeta.idRegUltimaAct : null,
      ultimaActuacion: carpeta.ultimaActuacion ? carpeta.ultimaActuacion : null,
