...
export function ActuacionesSlideshow(
  {
    actuacionesPromise
      ...
      Next
            ...
            { showMore && (
              <>
                <p className={ typography.bodySmall }>Por favor verifique que el número de expediente esté completo con los 23 dígitos y vuelva a intentarlo. <strong className={typography.labelMedium}>gracias</strong></p>
          ...
          { showMore && (
            <>
              ...
              <h2 className={ typography.labelLarge }>
                <OutputDateHelper incomingDate={ sculpture.fechaActuacion } /></h2>
              <h3>
