...
export const DateInputSection = ({
  ...
  const dateValue = initialValue ? initialValue : new Date();

  const [stringDateValue, setStringDateValue] = useState(dateValue);
      ...
      <section className={layout.segmentRow}>
        ...
        <input
          ...
          onChange={(e) => {
            ...
            setStringDateValue(new Date(newYear, newMonth, newDay));
          }}
        />
      </section>
