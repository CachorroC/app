...
export default function Sidebar({ carpetas, activeCategory = 'todos', onSelectCategory, theme, onToggleTheme, open = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className={`${styles.scrim} ${open ? styles.scrimOpen : ''}`} onClick={onClose} aria-hidden />
