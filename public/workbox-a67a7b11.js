define(
  [
    ...
    const e = (
      ...
      return e.length > 0 && ( s += ` :: ${ JSON.stringify(
        e 
      ) }` ), s;
    };
        ...
        for ( const r of i ) {
          ...
          if ( o ) {
            return (
              ...
              || ( o.constructor === Object && 0 === Object.keys(
                o 
              ).length )
              || 'boolean' == typeof o )
              && ( i = void 0 ),
      ...
      constructor() {
        ...
        ( this.cachedResponseWillBeUsed = async (
          ...
          if (
            ...
            s
              ? this.notUpdatedURLs.push(
                t 
              )
              : this.updatedURLs.push(
                t 
              );
          }
    ...
    class y {
      constructor(
        ...
        ( this.cacheKeyWillBeUsed = async (
          ...
          = ( null == e
            ? void 0
            : e.cacheKey ) || this.h.getCacheKeyForURL(
            t.url 
          );
    ...
    class L {
      ...
      async cacheMatch(
        ...
        const {
          cacheName: n, matchOptions: i 
        } = this.l,
              r = await this.getCacheKey(
                e, 'read' 
              ),
              o = Object.assign(
                Object.assign(
      ...
      async cachePut(
        ...
        const r = await this.getCacheKey(
          n, 'write' 
        );
        ...
        const {
          cacheName: a, matchOptions: h 
        } = this.l,
              u = await self.caches.open(
                a 
              ),
              l = this.hasCallback(
                'cacheDidUpdate' 
    ...
    class b {
      ...
      async q(
        ...
        for ( const s of t.iterateCallbacks(
          'handlerWillRespond' 
        ) ) {
          i = await s(
            {
    ...
    class C extends b {
      ...
      N() {
        ...
        0 === e
          ...
          : e > 1 && null !== t && this.plugins.splice(
            t, 1 
          );
      }
    }
    ...
    class E {
      constructor(
        ...
        ( this.activate = this.activate.bind(
          this 
        ) );
      }
      get strategy() {
      ...
      install(
        ...
        return w(
          t, async () => {
            ...
            const {
              updatedURLs: s, notUpdatedURLs: n 
            } = e;
      ...
      activate(
        ...
        return w(
          t, async () => {
            const t = await self.caches.open(
      ...
      async matchPrecache(
        ...
        const e = t instanceof Request
          ? t.url
          : t,
              s = this.getCacheKeyForURL(
                e 
              );

        if ( s ) {
          return ( await self.caches.open(
            this.strategy.cacheName 
          ) ).match(
            s 
          );
      ...
      createHandlerBoundToURL(
        ...
        const e = this.getCacheKeyForURL(
          t 
        );
...
//# sourceMappingURL=workbox-a67a7b11.js.map
